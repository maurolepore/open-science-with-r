...
Use the tidyverse, which includes the package dplyr
...
url <- "https://raw.githubusercontent.com/carpentries-incubator/open-science-with-r/gh-pages/data/gapminder.csv"
gapminder <- readr::read_csv(url)
```
